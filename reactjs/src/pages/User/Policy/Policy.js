                ...
                {params.pk == 2 ?
                    <>
                        <Text>
                            ...
                            대가의선택에서 발행되는 모든 콘텐츠는 저작권법에 의하여 보호받는 저작물로서 저작권은 ㈜퍼스트파트너스에 있습니다.<br /><br />

                            대가의선택(㈜퍼스트파트너스)의 허락 없이 콘텐츠에 대한 무단 복제 및 배포 등 저작권을 침해하는 행위를 금합니다.<br /><br />

                            대가의선택(㈜퍼스트파트너스)에서 발행하는 모든 콘텐츠를 무단으로 상업적으로 이용하거나 기타 영리 목적으로 이용할 경우 민법상 부당이득, 불법행위 등을 이유로 손해배상 책임을 질 수 있습니다.<br />
                            상업적 또는 기타 영리 목적 등으로 이용을 원할 경우 사전에 대가의선택(㈜퍼스트파트너스)와 별도 협의를 하거나 허락을 얻어야 하며, 협의 또는 허락을 얻어 자료의 내용을 게재하는 경우에도 출처가 대가의선택(㈜퍼스트파트너스)임을 반드시 밝혀야 합니다.<br /><br />

                            대가의선택(㈜퍼스트파트너스)에서 발행하는 모든 콘텐츠를 블로그, SNS, 개인용, 비상업용 등 공익, 비영리 목적에 이용할 경우에도 출처를 대가의선택(㈜퍼스트파트너스)로 명시하여야 합니다.<br /><br />

                            대가의선택(㈜퍼스트파트너스)의 콘텐츠를 적법한 절차에 따라 다른 인터넷 사이트에 게재하는 경우에도 내용의 무단 변경을 금지하며, 이를 위반할 때에는 형사처벌을 받을 수 있습니다.<br /><br />
